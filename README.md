...
[![Build Status](https://travis-ci.org/RomanGotsiy/new-generator-test.svg?branch=master)](https://travis-ci.org/RomanGotsiy/new-generator-test)
## Steps to finish
...
6. If you did everything correct, https://romangotsiy.github.io/new-generator-test/ will lead to your new docs
...
- Documentation(ReDoc): https://romangotsiy.github.io/new-generator-test/
- SwaggerUI: https://romangotsiy.github.io/new-generator-test/swagger-ui/
- Look full spec:
    + JSON https://romangotsiy.github.io/new-generator-test/openapi.json
    + YAML https://romangotsiy.github.io/new-generator-test/openapi.yaml
- Preview spec version for branch `[branch]`: https://romangotsiy.github.io/new-generator-test/preview/[branch]
...
6. Share you changes with the rest of the world by pushing it to GitHub :smile:
